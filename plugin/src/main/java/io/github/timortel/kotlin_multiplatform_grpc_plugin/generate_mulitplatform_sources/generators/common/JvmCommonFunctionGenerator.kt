...
class JvmCommonFunctionGenerator(private val builder: FileSpec.Builder) : CommonFunctionGenerator() {

    override fun addFunction(funSpec: FunSpec) {
        builder.addFunction(funSpec)
    }

    override fun getNativePlatformType(message: ProtoMessage): TypeName = message.jvmType
